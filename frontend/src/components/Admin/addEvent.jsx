...
const AddEvent = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:5000/event/addEvent', eventFormData, {
        headers: {
  ...
  return (
    <div className="max-w-lg mx-auto p-4 mt-10 bg-white shadow-lg rounded-lg">
      <h2 className="text-2xl font-bold text-center mb-6">Add a New Event</h2>
      {success && <p className="text-green-500 text-center mb-4">Event added successfully!</p>}
